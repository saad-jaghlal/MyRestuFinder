...
public class MainActivity extends AppCompatActivity implements  AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        magasins.add( new Magasin("restu2","Rapat","06592777"));
        magasins.add(new Magasin("restu3","Fes","06598855"));
        magasins.add(new Magasin("restu4","Casa","0659555525"));
        magasins.add(new Magasin("restu5","Casa","0659555525"));
        HashMap<Integer,List<Magasin>> magasinList;
